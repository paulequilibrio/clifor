...
contains
  ...
  subroutine test_clifor_mod_program_info_minimum
    use clifor_mod_program_info, only: clifor_type_program_info
  ...
  end subroutine test_clifor_mod_program_info_minimum


  subroutine test_clifor_mod_program_info_with_pretty_name
    use clifor_mod_program_info, only: clifor_type_program_info
    type(clifor_type_program_info) :: info
  ...
  end subroutine test_clifor_mod_program_info_with_pretty_name


  subroutine test_clifor_mod_program_info_with_description
    use clifor_mod_program_info, only: clifor_type_program_info
    type(clifor_type_program_info) :: info
  ...
  end subroutine test_clifor_mod_program_info_with_description


  subroutine test_clifor_mod_program_info_with_named_arguments
    use clifor_mod_program_info, only: clifor_type_program_info
    type(clifor_type_program_info) :: info
  ...
  end subroutine test_clifor_mod_program_info_with_named_arguments

end module test_clifor_mod_program_info
